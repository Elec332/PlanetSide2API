...
//                "&c:tree=start:rank_map^field:ordinal");
                ...
                new CensusRequestBuilder()
                        ...
                        .join("outfit_member", j -> j.asList().injectAt("member_map").show("character_id")
                                .nested("character", j2 -> j2.show("times.last_save", "character_id").injectAt("character")
                                        .nested("outfit_member", j3 -> j3.on("character_id").injectAt("outfit_info").show("member_since", "rank_ordinal"))
                                )
                        )
